...
public class Base extends JComponent implements Runnable, KeyListener
{
    ...
    public void paintComponent( Graphics window )
    {
        ...
        window.fillRect(0,0,800,50);
        window.setColor(Color.BLACK);
        window.drawString("PLAYER 1 SCORE : "+p1score,10,10);
        window.drawString("PLAYER 2 SCORE : "+p2score,10,20);
        window.drawString("PRESS SPACE TO RESET",10,30);
    }
    ...
    {
        return p.getX() < 800 && p.getX() >= 0 && p.getY() < 800 && p.getY() >= 50;
    }
